      ...
      <section className="mx-auto max-w-md px-6 py-14">
        <div className="rounded-3xl bg-forest p-8 text-parchment shadow-xl ring-1 ring-forest/30">
          <header className="mb-6">
            <p className="text-parchment/85 font-semibold tracking-wide">Welcome</p>
            <h1 className="mt-2 font-headings text-3xl leading-tight">Log in</h1>
            <p className="mt-3 text-sm text-parchment/90">
              The letters are waiting. Step back into your story.
            </p>
          </header>
          ...
          <form onSubmit={onSubmit} className="flex flex-col gap-4">
            ...
            <p className="mt-2 text-center text-sm text-parchment/85">
              New here?{' '}
              <Link href="/signup" className="text-parchment underline underline-offset-4">
                Sign up
              </Link>
            </p>
          </form>
